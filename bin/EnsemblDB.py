...
parser = OptionParser(usage='CAVA-{}/ensembl_db <options>'.format(version), version=version, description=descr,
                      epilog=epilog)
...
parser.add_option('-s', "--select", default=False, dest='select', action='store_true',
                  help="Select transcript for each gene [default: %default]")
